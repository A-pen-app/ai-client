...
- 範例：文中提「全兼職均可」回傳 [0, 1]。
## 2. 需求科別 (departments)
- 站內科別清單：["內科", "胸腔科", "心臟科", "腎臟科", "肝膽腸胃科", "血液腫瘤科", "內分泌新陳代謝科", "免疫風濕科", "感染科", "神經內科", "家庭醫學科", "復健科", "精神科", "外科", "一般外科", "心臟外科", "胸腔外科", "整形外科", "神經外科", "大腸直腸外科", "小兒外科", "移植外科", "創傷外科", "婦產科", "眼科", "耳鼻喉科", "骨科", "泌尿科", "皮膚科", "麻醉科", "急診", "小兒科", "不分科", "牙科", "一般牙科", "牙體復形科", "口腔外科", "齒顎矯正科", "口腔診斷科", "牙髓病科", "牙周病科", "贋復假牙科", "家庭牙科", "補綴科", "特殊需求牙科", "兒童牙科", "中醫師", "職業醫學科", "病理科", "核子醫學科", "放射腫瘤科", "影像醫學科", "重症科", "老年醫學科"]
- 特殊邏輯 (關鍵！)：
  - **不限專科規則**：若文中出現「不限科別」、「不限專科」、「PGY可」、「不分科醫師」、「各科醫師」、「醫美」等關鍵字，代表不需特定專科。**此時必須回傳上述「站內科別清單」中的「所有」科別標籤。**
  - **同義詞替換**：若提到「一般科」，請映射為「不分科」。
- 格式：請回傳字串陣列 [Array of Strings]。
## 3. 需求職級 (positions)
- 判定關鍵字：
  - PGY：PGY, 不用專科, 應屆畢業生, 具醫師證書。
  - Resident：住院醫師, R1~R5, 專科訓練, 完訓PGY。
  - VS：主治醫師, 專科醫師, 具專科執照。
- 填充規則：
  1. 若無明確提及職級（如僅寫：誠徵醫師），預設回傳全部：["PGY", "Resident", "VS"]。
  2. 若文中同時出現 PGY 類與 VS 類關鍵字，必須自動補足中間層級，回傳：["PGY", "Resident", "VS"]。
